...
//  public static final RelOptRule JOIN_AGG_FILTER_PROJECT_SCAN = new SemiJoinIndexScanPrule(
...
//
//  public static final RelOptRule JOIN_AGG_FILTER_PROJECT_FILTER_SCAN = new SemiJoinIndexScanPrule(
//          RelOptHelper.some(DrillJoinRel.class,
//                  RelOptHelper.some(DrillAggregateRel.class,
//                          RelOptHelper.some(DrillProjectRel.class,
