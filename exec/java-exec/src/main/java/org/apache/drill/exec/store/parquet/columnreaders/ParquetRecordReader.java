...
*/
  ...
  public void setup(OperatorContext operatorContext, OutputMutator output) throws ExecutionSetupException {
    ...
    batchStatsLogging    = new RecordBatchStatsContext(fragmentContext, operatorContext);
    schema               = new ParquetSchema(fragmentContext.getOptions(), rowGroupIndex, footer, isStarQuery() ? null : getColumns());
    batchSizerMgr        = new RecordBatchSizerManager(fragmentContext.getOptions(), schema, numRecordsToRead, batchStatsLogging);
